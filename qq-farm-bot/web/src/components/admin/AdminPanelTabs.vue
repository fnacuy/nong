...
export type AdminTabKey = 'card' | 'user' | 'log' | 'system' | 'announcement'
...
<template>
  <div class="max-w-full min-w-0 border border-gray-200 rounded-lg bg-white shadow dark:border-gray-700 dark:bg-gray-800">
