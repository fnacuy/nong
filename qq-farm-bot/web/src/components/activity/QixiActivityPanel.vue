...
const emit = defineEmits<{ 'build': [], 'gift': [friendGid: number, count: number], 'update:dewAuto': [value: boolean] }>()
...
<template>
  <div class="space-y-4">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 rounded-xl bg-white p-5 shadow-sm dark:bg-gray-800">
      ...
      <BaseSwitch :model-value="!!dewAuto" label="自动使用" @update:model-value="emit('update:dewAuto', !!$event)" />
    </div>
