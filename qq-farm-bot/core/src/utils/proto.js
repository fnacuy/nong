...
async function loadProto() {
    ...
    types.PetStatus = root.lookupType('gamepb.dogpb.PetStatus');
    ...
    types.DogFoodListInfo = root.lookupType('gamepb.dogpb.DogFoodListInfo');
    types.GuardLogEntry = root.lookupType('gamepb.dogpb.GuardLogEntry');
