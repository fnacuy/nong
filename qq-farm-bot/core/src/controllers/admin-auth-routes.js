...
function registerAdminAuthRoutes({
  ...
  app.post("/api/login", (req, res) => {
    ...
    return res.json({
      ...
      data: {
        ...
        turbo: validationResult.turbo || null,
        premium: validationResult.premium || null,
  ...
  app.post("/api/user/renew", requireAdminToken, (req, res) => {
    ...
    if (typeof broadcastPremiumStatus === "function") broadcastPremiumStatus(username);
