...
const { registerAdminYybProxyRoutes } = require("./admin-yyb-proxy-routes");
...
function startAdminServer(dataProvider) {
  ...
  registerAdminAuthRoutes({
    ...
    createAdminSession,
    updateAdminSessions,
    broadcastPremiumStatus: provider.broadcastPremiumStatus,
  });
  ...
  registerAdminAccountRoutes({
    ...
    requireSuperAdminRole,
    requireDangerConfirmation,
    expiredCodeCleaner: provider.expiredCodeCleaner,
    store,
  });
